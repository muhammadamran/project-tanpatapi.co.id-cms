    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a href="index.php?m=content&s=3-list&n=<?= $_GET['n']; ?>" class="nav-link">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-inverse" data-sortable-id="index-6">
                                <div class="panel-body">
                                    ...
                                    <?php
                                    $fDucplicate = $db->query("SELECT rorder, COUNT(*) duplikat FROM tb_tumpeng_menu GROUP BY rorder HAVING COUNT(duplikat) > 1");
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="pages/content/action.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="add_tumpeng_menu_" class="btn btn-secondary"><i class="fas fa-save"></i> Add</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="TableDefault_L" class="table table-striped table-bordered table-td-valign-middle">
                                            ...
                                            <tbody>
                                                <?php
                                                $dataTable = $db->query("SELECT * FROM tb_tumpeng_menu ORDER BY rorder ASC");
                                                            ...
                                                            <td style="text-align:center">
                                                                <div class="action-table">
                                                                    ...
                                                                    <div style="margin-left: 5px;">
                                                                        ...
                                                                        <a href="index.php?m=content&s=3-menu-u&n=<?= $_GET['n']; ?>&id=<?= $row['id'] ?>" target="_blank" class="btn btn-success" title="Update Data"><i class="fas fa-edit"></i>
                                                                            <font class="f-action">Update</font>
                                                                        </a>
                                                                    </div>
                                                                    <div style="margin-left: 5px;">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="javascript:;" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> Close</a>
                                                                            <button type="submit" name="upload_tumpeng_menu_" class="btn btn-lime"><i class="fas fa-image"></i> Change Photo</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" class="btn btn-danger" name="delete_tumpeng_menu_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> No</button>
                                                                            <button type="submit" class="btn btn-enabled" name="enabled_tumpeng_menu_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> No</button>
                                                                            <button type="submit" class="btn btn-disabled" name="disabled_tumpeng_menu_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="javascript:;" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> Close</a>
                                                                            <button type="submit" name="update_tumpeng_menu_" class="btn btn-success"><i class="fas fa-edit"></i> Update</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
