    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a href="index.php?m=content&s=4&n=<?= $_GET['n']; ?>" class="nav-link active">
                        <span class="d-sm-none">Tab 1</span>
                        <span class="d-sm-block d-none"><?= $_GET['n']; ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.php?m=content&s=4-sweet&n=<?= $_GET['n']; ?>" class="nav-link">
                                ...
                                <div class="panel-body">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="pages/content/action.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="add_snackbox_" class="btn btn-secondary"><i class="fas fa-save"></i> Add</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="TableDefault_L" class="table table-striped table-bordered table-td-valign-middle">
                                            ...
                                            <tbody>
                                                <?php
                                                $dataTable = $db->query("SELECT * FROM tb_snackbox WHERE type IS NULL ORDER BY id DESC");
                                                ...
                                                ?>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td width="1%" class="with-img">
                                                                <img src="assets/menu/snackbox/<?= $row['pictures'] ?>" class="img-rounded height-50" style="width: 65px;" />
                                                            </td>
                                                            <td>
                                                                <div class="oke-icon">
                                                                    <!-- Icon -->
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST" enctype="multipart/form-data">
                                                                                                    ...
                                                                                                    <div style="display: flex;justify-content: space-between;align-items: center;">
                                                                                                        <div>
                                                                                                            <a href="javascript:;" class="pull-left">
                                                                                                                <img class="media-object rounded" src="assets/menu/snackbox/<?= $row['pictures'] ?>" alt="<?= $row['title']; ?>" />
                                                                                                            </a>
                                                                                                        </div>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="javascript:;" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> Close</a>
                                                                            <button type="submit" name="upload_snackbox_" class="btn btn-lime"><i class="fas fa-image"></i> Change Photo</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="javascript:;" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> Close</a>
                                                                            <button type="submit" name="update_snackbox_" class="btn btn-success"><i class="fas fa-edit"></i> Update</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" class="btn btn-danger" name="delete_snackbox_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> No</button>
                                                                            <button type="submit" class="btn btn-enabled" name="enabled_snackbox_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> No</button>
                                                                            <button type="submit" class="btn btn-disabled" name="disabled_snackbox_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
