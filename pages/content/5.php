    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a href="index.php?m=content&s=5&n=<?= $_GET['n']; ?>" class="nav-link active">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="pages/content/action.php" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            <fieldset>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="IdSlogan">Slogan <font style="color:red">*</font></label>
                                                                            <input type="text" class="form-control" name="Slogan" id="IdSlogan" placeholder="Slogan ..." required />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="IdBoxtitle">Boxtitle <font style="color:red">*</font></label>
                                                                            <input type="text" class="form-control" name="Boxtitle" id="IdBoxtitle" placeholder="Boxtitle ..." required />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="add_aboutus_" class="btn btn-secondary"><i class="fas fa-save"></i> Add</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <table id="TableDefault_L" class="table table-striped table-bordered table-td-valign-middle">
                                            <thead>
                                                <tr style="text-transform: uppercase;text-align:center">
                                                    ...
                                                    <th width="1%" data-orderable="false"></th>
                                                    <th class="text-nowrap">Title & Slogan</th>
                                                    <th class="text-nowrap">Boxtitle & Description</th>
                                                    <th class="text-nowrap">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $dataTable = $db->query("SELECT * FROM tb_aboutus ORDER BY id DESC");
                                                ...
                                                ?>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td width="1%" class="with-img">
                                                                <img src="assets/about/<?= $row['pictures'] ?>" class="img-rounded height-50" style="width: 65px;" />
                                                            </td>
                                                            <td>
                                                                <div class="oke-icon">
                                                                    <!-- Icon -->
                                                        ...
                                                        <div class="modal fade" id="descModal<?= $row['id'] ?>">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header for-secondary">
                                                                        <h4 class="modal-title">Boxtitle & Description</h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <fieldset>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST" enctype="multipart/form-data">
                                                                                                    ...
                                                                                                    <div style="display: flex;justify-content: space-between;align-items: center;">
                                                                                                        <div>
                                                                                                            <a href="javascript:;" class="pull-left">
                                                                                                                <img class="media-object rounded" src="assets/about/<?= $row['pictures'] ?>" alt="<?= $row['title']; ?>" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                                    ...
                                                                                                                    <div class="card">
                                                                                                                        ...
                                                                                                                        <div class="card-content">
                                                                                                                            <div class="card-body">
                                                                                                                                ...
                                                                                                                                <input type="hidden" name="Slogan" id="Slogan" value="<?= $row['slogan']; ?>" />
                                                                                                                                <input type="hidden" name="Boxtitle" id="Boxtitle" value="<?= $row['boxtitle']; ?>" />
                                                                                                                                <input type="hidden" name="Page" id="page" value="<?= $_GET['n']; ?>" />
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="javascript:;" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> Close</a>
                                                                            <button type="submit" name="upload_aboutus_" class="btn btn-lime"><i class="fas fa-image"></i> Change Photo</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" class="form-control" name="Slogan" id="IdSlogan" placeholder="Slogan ..." value="<?= $row['slogan']; ?>" />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            <label for="IdBoxtitle">Boxtitle </label>
                                                                                            <input type="text" class="form-control" name="Boxtitle" id="IdBoxtitle" placeholder="Boxtitle ..." value="<?= $row['boxtitle']; ?>" />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="javascript:;" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> Close</a>
                                                                            <button type="submit" name="update_aboutus_" class="btn btn-success"><i class="fas fa-edit"></i> Update</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" class="btn btn-danger" name="delete_aboutus_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> No</button>
                                                                            <button type="submit" class="btn btn-enabled" name="enabled_aboutus_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> No</button>
                                                                            <button type="submit" class="btn btn-disabled" name="disabled_aboutus_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
