    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a href="index.php?m=content&s=4-savory&n=<?= $_GET['n']; ?>" class="nav-link active">
                        <span class="d-sm-none">Tab 2</span>
                                ...
                                <div class="panel-body">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="pages/content/action.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="add_snackbox_savory_" class="btn btn-secondary"><i class="fas fa-save"></i> Add</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="TableDefault_L2" class="table table-striped table-bordered table-td-valign-middle">
                                            ...
                                            <tbody>
                                                <?php
                                                $dataTable = $db->query("SELECT * FROM tb_ss WHERE type='savory' ORDER BY id DESC");
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a href="javascript:;" class="btn btn-white" data-dismiss="modal"><i class="fas fa-times-circle"></i> Close</a>
                                                                            <button type="submit" name="update_snackbox_savory_" class="btn btn-success"><i class="fas fa-edit"></i> Update</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="pages/content/action.php" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" class="btn btn-danger" name="delete_snackbox_savory_"><i class="fas fa-check-circle"></i> Yes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
