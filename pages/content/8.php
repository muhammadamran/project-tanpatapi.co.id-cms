                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="TableDefault_L" class="table table-striped table-bordered table-td-valign-middle">
                                            ...
                                            <tbody>
                                                <?php
                                                $dataTable = $db->query("SELECT * FROM tb_contact ORDER BY id DESC");
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <div class="oke-icon">
                                                                    ...
                                                                    <!-- Text -->
                                                                    <div style="margin-left: 10px;">
                                                                        <a href="tel:<?= $row['telephone'] != NULL ? $row['telephone'] : '#' ?>" target="_blank" style="font-size: 14px;font-weight: 900;">
                                                                            <?= $row['telephone'] != NULL ? $row['telephone'] : '<center><i style="color:red">NULL</i></center>' ?>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="oke-icon">
                                                                    <!-- Icon -->
                                                                    <div class="elemen-bg-icon" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="bottom" data-content="Whatsapp">
                                                                        <img src="assets/icon/whatsapp.png" style="width: 20px;">
                                                                    </div>
                                                                    <!-- Text -->
                                                                    <div style="margin-left: 10px;">
                                                                        <a href="https://wa.me/<?= $row['whatsapp'] != NULL ? $row['whatsapp'] : '#' ?>" target="_blank" style="font-size: 14px;font-weight: 900;">
                                                                            <?= $row['whatsapp'] != NULL ? $row['whatsapp'] : '<center><i style="color:red">NULL</i></center>' ?>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="oke-icon">
                                                                    <!-- Icon -->
                                                                    <div class="elemen-bg-icon" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="bottom" data-content="Instgaram">
                                                                        <img src="assets/icon/instagram.png" style="width: 20px;">
                                                                    </div>
                                                                    <!-- Text -->
                                                                    <div style="margin-left: 10px;">
                                                                        <a href="http://instagram.com/<?= $row['instagram'] != NULL ? str_replace("@", "", $row['instagram']) : '#' ?>" target="_blank" style="font-size: 14px;font-weight: 900;">
                                                                            <?= $row['instagram'] != NULL ? $row['instagram'] : '<center><i style="color:red">NULL</i></center>' ?>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
